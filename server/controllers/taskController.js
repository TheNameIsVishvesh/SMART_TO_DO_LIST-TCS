...
function getRelativeDate(daysOffset) {
  ...
  d.setHours(17, 0, 0, 0); // Default to 5:00 PM
  return d.toISOString();
}

// Student tasks dataset for seeding
const getDemoTasks = () => [
  {
    title: 'Final Year Web Development Capstone Project',
    description: 'Implement frontend dashboard layout, connect REST API routes, secure database with schema checks, and write end-to-end unit tests. Deploy code to live server.',
    category: 'Projects',
    tags: ['mern', 'react', 'mongodb', 'final-year'],
    priority: 'HIGH',
    status: 'TODO',
